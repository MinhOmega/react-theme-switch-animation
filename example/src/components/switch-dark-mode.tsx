...
import { ReactThemeSwitchAnimationProps, useModeAnimation } from '../../../src/index'
...
const SwitchDarkMode: React.FC<SwitchDarkModeProps> = ({
  ...
  return (
    <button
      ...
      className={`relative text-2xl md:text-3xl w-12 h-12 rounded-full text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 focus:outline-none flex items-center justify-center group ${className}`}
